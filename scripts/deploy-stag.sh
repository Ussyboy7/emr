...
wait_for_services() {
    ...
    while [ $attempt -le $max_attempts ]; do
        if curl -sf http://localhost:8047/api/ > /dev/null 2>&1; then
...
show_status() {
    ...
    echo "  - Frontend: http://172.16.0.46:4647"
    echo "  - Backend API: http://172.16.0.46:8047/api/"
    echo "  - Health Check: http://172.16.0.46:4647"
    echo "  - Admin Panel: http://172.16.0.46:8047/admin/"
    echo ""
