...
const statisticalReports: StatisticalReportTile[] = [
  {
    ...
    description: "All MR sections in one bundle — attendance, lab, radiology, referrals, diagnoses, PDF export",
    icon: Layers,
    href: "/medical-records/reports/comprehensive",
    borderAccent: "border-l-teal-600",
    iconWrap: "bg-teal-600/10",
  ...
  },
  {
    ...
    description: "Current vs previous period by category with % change",
    icon: BarChart3,
  ...
  {
    id: "observation-admissions",
    title: "Observation Admissions",
    description: "Patients placed on observation — admission events by category",
    icon: Activity,
    href: "/medical-records/reports/observation-admissions",
  ...
  },
  {
    ...
    description: "Radiology studies by modality and location (as stored in EMR)",
    icon: ScanLine,
  ...
  },
  {
    ...
    description: "ICD-10 diagnoses from completed consultations",
    icon: TrendingUp,
  ...
  {
    id: "disease-pattern-compared",
    title: "Disease Pattern Compared",
    description: "ICD-10 diagnoses across 3 consecutive periods",
    icon: TrendingUp,
    href: "/medical-records/reports/disease-pattern-compared",
    borderAccent: "border-l-rose-500",
    iconWrap: "bg-rose-500/10",
    iconClass: "text-rose-500",
  },
  {
    id: "physio-clinical-diagnosis",
    title: "Physio Clinical Diagnosis",
    description: "ICD-10 diagnoses from completed physiotherapy sessions",
    icon: Activity,
    href: "/medical-records/reports/physio-clinical-diagnosis",
    borderAccent: "border-l-orange-600",
    iconWrap: "bg-orange-600/10",
    iconClass: "text-orange-600",
  },
  {
    id: "eye-clinical-diagnosis",
    title: "Eye Clinical Diagnosis",
    description: "ICD-10 diagnoses from completed ophthalmology sessions",
    icon: Stethoscope,
    href: "/medical-records/reports/eye-clinical-diagnosis",
