              ...
              <div className="space-y-6">
                ...
                <div className="border-b pb-4">
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <div className="space-y-1">
                        <p><span className="font-medium">Name:</span> {selectedSession.patient_name}</p>
                        <p><span className="font-medium">ID:</span> {selectedSession.patient_id}</p>
                        <p><span className="font-medium">Physiotherapist:</span> {selectedSession.physiotherapist_name || 'Not specified'}</p>
                      </div>
                    </div>
                    <div className="space-y-2">
                  ...
                  {selectedSession.order_details?.diagnosis && (
                    <div className="mt-4 p-3 bg-amber-50 dark:bg-amber-900/20 rounded-lg border border-amber-200 dark:border-amber-800">
                      ...
                      <p className="text-sm mt-1">{selectedSession.order_details.diagnosis}</p>
                    </div>
                  )}
                </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <p className="text-sm bg-muted/50 p-3 rounded border min-h-[60px]">
                          {selectedSession.presenting_complaint || 'Not documented'}
                        </p>
                      </div>
                      <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          <div className="text-center p-3 bg-red-50 dark:bg-red-900/20 rounded border">
                            ...
                            <p className="text-xl font-bold text-red-600">{selectedSession.pain_level_before || 'N/A'}/10</p>
                          </div>
                          <div className="text-center p-3 bg-green-50 dark:bg-green-900/20 rounded border">
                            ...
                            <p className="text-xl font-bold text-green-600">{selectedSession.pain_level_after || 'N/A'}/10</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <p className="text-sm bg-muted/50 p-3 rounded border min-h-[60px]">
                          {selectedSession.medical_history || 'Not documented'}
                        </p>
                      </div>
                      <div className="space-y-2">
                        <Label className="text-sm font-medium">Medications</Label>
                        <p className="text-sm bg-muted/50 p-3 rounded border min-h-[60px]">
                          {selectedSession.medications || 'Not documented'}
                        </p>
                      </div>
                      <div className="space-y-2">
                        <Label className="text-sm font-medium">Social History</Label>
                        <p className="text-sm bg-muted/50 p-3 rounded border min-h-[60px]">
                          {selectedSession.social_history || 'Not documented'}
                        </p>
                      </div>
                      <div className="space-y-2">
                        <Label className="text-sm font-medium">Previous Treatments</Label>
                        <p className="text-sm bg-muted/50 p-3 rounded border min-h-[60px]">
                          {selectedSession.previous_treatments || 'Not documented'}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <p className="text-sm bg-muted/50 p-3 rounded border min-h-[60px]">
                          {selectedSession.posture_gait || 'Not documented'}
                        </p>
                      </div>
                      <div className="space-y-2">
                        <Label className="text-sm font-medium">Range of Motion</Label>
                        <p className="text-sm bg-muted/50 p-3 rounded border min-h-[60px]">
                          {selectedSession.range_of_motion || 'Not documented'}
                        </p>
                      </div>
                      <div className="space-y-2">
                        <Label className="text-sm font-medium">Muscle Strength</Label>
                        <p className="text-sm bg-muted/50 p-3 rounded border min-h-[60px]">
                          {selectedSession.muscle_strength || 'Not documented'}
                        </p>
                      </div>
                      <div className="space-y-2">
                        <Label className="text-sm font-medium">Special Tests</Label>
                        <p className="text-sm bg-muted/50 p-3 rounded border min-h-[60px]">
                          {selectedSession.special_tests || 'Not documented'}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <p className="text-sm bg-muted/50 p-3 rounded border min-h-[60px]">
                          {selectedSession.functional_assessment || 'Not documented'}
                        </p>
                      </div>
                      <div className="space-y-2">
                        <Label className="text-sm font-medium">Functional Goals</Label>
                        <p className="text-sm bg-muted/50 p-3 rounded border min-h-[60px]">
                          {selectedSession.functional_goals || 'Not documented'}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm bg-muted/50 p-3 rounded border min-h-[80px]">
                        {selectedSession.clinical_reasoning || selectedSession.assessment_findings || 'Not documented'}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm bg-muted/50 p-3 rounded border min-h-[80px]">
                        {selectedSession.next_session_plan || selectedSession.treatment_performed || 'Not documented'}
                      </p>
                    </div>
                  </div>

                  {/* Treatment Performed & Outcomes */}
                  {(selectedSession.treatment_performed || selectedSession.progress_notes) && (
                    <div className="space-y-3">
                  ...
                  {(selectedSession.home_exercises || selectedSession.recommendations) && (
                    <div className="space-y-3">
                ...
                <div className="border-t pt-4">
                  <div className="flex items-center justify-between text-xs text-muted-foreground">
                    ...
                    <p>Session ID: PHY-{selectedSession.id?.toString().padStart(6, '0')}</p>
                  </div>
                </div>
              </div>
            )}
