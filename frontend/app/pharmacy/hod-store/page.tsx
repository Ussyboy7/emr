            ...
            <Card className={`border-l-4 border-l-rose-500 ${storeStats.outOfStock > 0 ? "border-red-200 dark:border-red-800" : ""}`}>
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p
                      className={`text-2xl sm:text-3xl font-bold ${
                        storeStats.outOfStock > 0 ? "text-rose-600 dark:text-rose-400" : "text-emerald-600 dark:text-emerald-400"
                      }`}
                    >
                  ...
                  <XCircle
                    className={`h-8 w-8 ${
                      storeStats.outOfStock > 0 ? "text-rose-400" : "text-emerald-400"
                    }`}
                  />
                </div>
              </CardContent>
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p
                      className={`text-2xl sm:text-3xl font-bold ${
                        storeStats.lowStock > 0 ? "text-amber-600 dark:text-amber-400" : "text-emerald-600 dark:text-emerald-400"
                      }`}
                    >
                      {storeStats.lowStock}
                    </p>
                  ...
                  <AlertTriangle
                    className={`h-8 w-8 ${
                      storeStats.lowStock > 0 ? "text-amber-400" : "text-emerald-400"
                    }`}
                  />
                </div>
              </CardContent>
