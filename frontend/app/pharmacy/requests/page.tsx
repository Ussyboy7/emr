...
function DispensaryRequestsPageContent() {
  ...
  const statsCards = useMemo(
    () => [
      { label: "Total", value: stats.total, icon: Send, border: "border-l-violet-500", text: "text-violet-600 dark:text-violet-400", iconClass: "text-violet-400", filter: "all" },
      { label: "Pending", value: stats.pending, icon: Clock, border: "border-l-amber-500", text: "text-amber-600 dark:text-amber-400", iconClass: "text-amber-400", filter: "pending" },
      { label: "Approved", value: stats.approved, icon: Clock, border: "border-l-blue-500", text: "text-blue-600 dark:text-blue-400", iconClass: "text-blue-400", filter: "approved" },
      { label: "Confirmed", value: stats.confirmed, icon: CheckCircle2, border: "border-l-emerald-500", text: "text-emerald-600 dark:text-emerald-400", iconClass: "text-emerald-400", filter: "received", sub: stats.awaitingConfirmation ? `Awaiting: ${stats.awaitingConfirmation}` : undefined },
    ],
    [stats]
  );
