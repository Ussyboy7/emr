...
export default function StoreRequestsPage() {
  ...
  const stats = useMemo(() => [
    { label: "Total", value: statsData.total, icon: Send, border: "border-l-violet-500", text: "text-violet-600 dark:text-violet-400", iconClass: "text-violet-400", filter: "all" },
    { label: "Pending Review", value: statsData.pending, icon: Clock, border: "border-l-amber-500", text: "text-amber-600 dark:text-amber-400", iconClass: "text-amber-400", filter: "pending" },
    { label: "Approved", value: statsData.approved, icon: Zap, border: "border-l-blue-500", text: "text-blue-600 dark:text-blue-400", iconClass: "text-blue-400", filter: "approved" },
    { label: "Awaiting Confirmation", value: statsData.awaiting, icon: CheckCircle2, border: "border-l-emerald-500", text: "text-emerald-600 dark:text-emerald-400", iconClass: "text-emerald-400", filter: "fulfilled" },
  ], [statsData]);
