...
PAGE_TO_PERMISSION_MAP: dict[str, str] = {
    ...
    "/pharmacy/hod-store": "pharmacy_inventory",
    "/pharmacy/hod-store/requests": "pharmacy_inventory",
    "/pharmacy/hod-store/history": "pharmacy_view",
    ...
    "/eyecare": "eye_view",
    "/eyecare/orders": "eye_view",
    "/eyecare/completed": "eye_view",
    "/eyecare/analytics": "eye_view",
    ...
    "/admin/support-tickets": "admin_audit",
}
