"""
Physiotherapy analytics: comprehensive metrics for physiotherapy sessions, patient recovery, and treatment outcomes.
...
# Placeholder - physiotherapy models would be imported here
# from .models import PhysiotherapySession, PhysiotherapyOrder


def build_physiotherapy_analytics(
    start_date: datetime, end_date: datetime
) -> dict[str, Any]:
    """
    Build physiotherapy analytics.
